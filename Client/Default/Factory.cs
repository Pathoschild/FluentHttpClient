...
namespace Pathoschild.Http.Client.Default
{
	...
	public class Factory : IFactory
	{
		...
		***/
		...
		public IRequestBuilder GetRequestBuilder(HttpRequestMessage message, MediaTypeFormatterCollection formatters, Func<IRequestBuilder, Task<HttpResponseMessage>> responseBuilder)
		{
		...
		public IResponse GetResponse(HttpRequestMessage request, Task<HttpResponseMessage> task, MediaTypeFormatterCollection formatters, bool throwError = true)
		{
		...
		***/
		...
		public MediaTypeFormatter GetFormatter(MediaTypeFormatterCollection formatters, MediaTypeHeaderValue contentType = null)
		{
			if (!formatters.Any())
		...
		public MediaTypeFormatterCollection GetDefaultFormatters()
		{
		...
		public HttpRequestMessage GetRequestMessage(HttpMethod method, Uri resource)
		{
